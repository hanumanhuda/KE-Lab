 ...
 * @author hanuman
 */
public class AprioriHB {
   
    
    public static void main(String[] args)
    {
        //these data should be  according to the database;
        int no_of_item=5,no_of_trans=100,min_sup=2;
    ...
    static HashMap<HashSet<Integer>,Integer> apriori_gen(HashMap<HashSet<Integer>,Integer> hm,int min_sup)
    {
